...
func TestBuildSigninURL(t *testing.T) {
	...
	expected := "https://signin.aws.amazon.com/federation?Action=login&Destination=https%3A%2F%2Fconsole.aws.amazon.com%2F&Issuer=https%3A%2F%2Fgithub.com%2Fyouyo%2Fhidy%2F&SigninToken=siginin-token"
	if u != expected {
		t.Errorf("expected %v to eq %v", u, expected)
	}
}
